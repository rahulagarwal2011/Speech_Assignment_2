...
TERMS_BY_DOMAIN = {
    "speech_processing": [
        ...
        "speaker embedding", "x-vector", "d-vector", "i-vector",
        "mel spectrogram", "speech enhancement", "noise cancellation",
        "automatic speaker verification", "speaker recognition",
        "speech segmentation", "utterance", "speech corpus",
        "speech intelligibility", "speech quality", "mean opinion score",
        "forced alignment", "time alignment", "phoneme recognition",
    ...
    "signal_processing": [
        ...
        "discrete cosine transform", "DCT", "cepstral analysis",
        ...
        "pre-emphasis", "de-emphasis", "framing", "windowing",
        "overlap-add", "overlap-save", "circular convolution",
    ...
    "acoustics": [
        ...
        "acoustic impedance", "sound wave", "sound propagation",
        "diffraction", "reflection", "absorption",
        "noise floor", "ambient noise", "white noise",
        "pink noise", "Gaussian noise", "babble noise",
        "anechoic chamber", "near field", "far field",
        "beamforming", "microphone array", "spatial filtering",
    ],
    "machine_learning": [
        ...
        "contrastive learning", "triplet loss", "metric learning",
        "knowledge distillation", "model compression", "pruning",
        "quantization aware training", "mixed precision training",
        "attention head", "multi-head attention", "positional encoding",
        "feed-forward network", "residual connection", "skip connection",
        "weight initialization", "Xavier initialization", "He initialization",
        "gradient clipping", "gradient accumulation", "warmup schedule",
        "cosine annealing", "learning rate scheduler", "early stopping",
    ],
    "linguistics": [
        ...
        "WordPiece", "SentencePiece", "unigram model",
        "language family", "Indo-Aryan", "Dravidian",
        "agglutinative", "inflectional", "isolating",
        "morphological analysis", "lemmatization", "stemming",
        "compound word", "sandhi rules", "conjunct consonant",
    ],
    "phonetics": [
        ...
        "spectral tilt", "jitter", "shimmer",
        "harmonic to noise ratio", "HNR",
        "glottal pulse", "glottal flow",
        "acoustic correlate", "perception",
    ],
    "anti_spoofing": [
        "anti-spoofing", "spoofing detection", "replay attack",
        "speech synthesis attack", "voice conversion attack",
        "liveness detection", "presentation attack",
        "equal error rate", "EER", "detection error tradeoff",
        "bonafide speech", "spoof speech", "genuine speech",
        "countermeasure", "tandem detection cost function",
        "LFCC", "linear frequency cepstral coefficients",
        "CQCC", "constant Q cepstral coefficients",
        "light convolutional neural network", "LCNN",
        "max feature map", "MFM activation",
        "ASVspoof challenge", "logical access", "physical access",
        "deepfake detection", "audio deepfake",
        "generative adversarial network", "GAN",
        "variational autoencoder", "VAE",
        "WaveNet", "WaveRNN", "HiFi-GAN",
        "neural vocoder", "Griffin-Lim", "WORLD vocoder",
    ],
    "translation_nmt": [
        "machine translation", "neural machine translation",
        "parallel corpus", "bilingual corpus", "monolingual corpus",
        "source language", "target language", "pivot language",
        "low-resource language", "high-resource language",
        "back-translation", "data augmentation for NMT",
        "BLEU score", "METEOR score", "TER score",
        "alignment model", "phrase-based translation",
        "subword segmentation", "vocabulary size",
        "cross-lingual transfer", "multilingual model",
        "zero-shot translation", "few-shot learning",
        "domain adaptation", "terminology extraction",
        "transliteration model", "script conversion",
        "IndicTrans", "NLLB", "mBART", "XLM-RoBERTa",
    ],
}
...
HINDI_EQUIVALENTS = {
    ...
    "compression": "संपीड़न",
    "speaker embedding": "वक्ता अंतःस्थापन",
    "speech enhancement": "वाक् संवर्धन",
    "speech corpus": "वाक् संग्रह",
    "speech quality": "वाक् गुणवत्ता",
    "mean opinion score": "औसत राय अंक",
    "forced alignment": "बाध्य संरेखण",
    "noise cancellation": "शोर रद्दीकरण",
    "spectral centroid": "वर्णक्रमीय केन्द्रक",
    "zero crossing rate": "शून्य क्रॉसिंग दर",
    "discrete cosine transform": "असंतत कोसाइन रूपांतरण",
    "pre-emphasis": "पूर्व-बल",
    "framing": "फ्रेमिंग",
    "windowing": "विंडोइंग",
    "beamforming": "बीमफॉर्मिंग",
    "white noise": "श्वेत शोर",
    "ambient noise": "परिवेशी शोर",
    "sound wave": "ध्वनि तरंग",
    "contrastive learning": "विरोधाभासी अधिगम",
    "knowledge distillation": "ज्ञान आसवन",
    "model compression": "मॉडल संपीड़न",
    "attention head": "ध्यान शीर्ष",
    "multi-head attention": "बहु-शीर्ष ध्यान",
    "positional encoding": "स्थितीय एन्कोडिंग",
    "residual connection": "अवशिष्ट संयोजन",
    "gradient clipping": "प्रवणता क्लिपिंग",
    "early stopping": "शीघ्र रोक",
    "word embedding": "शब्द अंतःस्थापन",
    "subword tokenization": "उपशब्द टोकनीकरण",
    "byte pair encoding": "बाइट जोड़ी एन्कोडिंग",
    "lemmatization": "लेमेटाइज़ेशन",
    "stemming": "स्टेमिंग",
    "anti-spoofing": "एंटी-स्पूफिंग",
    "equal error rate": "समान त्रुटि दर",
    "deepfake detection": "डीपफेक पहचान",
    "neural vocoder": "तंत्रिका वोकोडर",
    "machine translation": "यंत्र अनुवाद",
    "neural machine translation": "तंत्रिका यंत्र अनुवाद",
    "parallel corpus": "समानांतर संग्रह",
    "source language": "स्रोत भाषा",
    "target language": "लक्ष्य भाषा",
    "low-resource language": "अल्प-संसाधन भाषा",
    "back-translation": "पश्च-अनुवाद",
    "BLEU score": "ब्लू स्कोर",
    "domain adaptation": "डोमेन अनुकूलन",
    "zero-shot translation": "शून्य-शॉट अनुवाद",
    "few-shot learning": "अल्प-शॉट अधिगम",
    "jitter": "जिटर",
    "shimmer": "शिमर",
    "spectral tilt": "वर्णक्रमीय झुकाव",
    "replay attack": "रीप्ले हमला",
    "liveness detection": "जीवंतता पहचान",
    "countermeasure": "प्रतिउपाय",
}
